...
<!-- Mirrored from templates.thememodern.com/theratio/our-services.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Feb 2025 06:22:22 GMT -->
...
<body>
    ...
    <div id="page" class="site">
        ...
        <section class="skill-process">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 mb-4 mb-lg-0 align-self-center">
                        <div class="skill-process-img">
                            <img src="images/construction/construction3.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 align-self-center">
                        <div class="skill-process-detail">
                            <div class="ot-heading is-dots">
                                <!-- <span>[ our skills ]</span> -->
                                <h2 class="main-heading">Enhance</h2>
                            </div>
                            <p>Our in-house experts design, build and install cleaner energy saving and environmentally-driven solutions, customised to our clients’ projects.</p>
                            <div class="ot-progress pb-3" data-percent="65" data-processed="true">
                                <div class="overflow"><span class="pname f-left">SSCC Constructions</span></div>
                                <div class="iprogress">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-5 mb-xl-0 order-first order-md-last order-xl-first">
                        <div class="benefits-detail">
                            <div class="ot-heading">
                                ...
                                <h2 class="main-heading">Enhance comprises of our divisions AMANA Solar and AMANA Energy-Saving.</h2>
                            </div>
                            <p>Our clients’ projects are enhanced through our offering of energy-saving solutions to drive sustainability and reduce costs. In 2015,
                                 we became the first DEWA (Dubai Electricity and Water Authority) certified contractor to install rooftop solar systems in Dubai.
                                 Today, we are also an Etihad ESCO approved energy service company.
                            </p>

                            <div class="ot-button">
                                <a href="portfolio.php" class="octf-btn octf-btn-dark">View Projects</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-box text-center">
                            <div class="box-content">
                                <div class="image-box img-lgpopup">
                                    <div data-src="images/construction/construction8.jpg">
                                        <img src="images/construction/construction8.jpg" alt=""><span class="overlay"><i class="ot-flaticon-add"></i></span>
                                    </div>
                                </div>
                                <div class="info-box">
                                    <h4>SSCC Solar</h4>
                                    <p>In-house expertise in designing, installing and maintaining rooftop and cap park solary systems. Providing comprehensive advantages for our clients, including cleaner energy solutions and reduced power costs.   
                                </p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="service-box text-center">
                            <div class="box-content">
                                <div class="image-box img-lgpopup">
                                    <div data-src="images/construction/construction7.jpg">
                                        <img src="images/construction/construction7.jpg" alt=""><span class="overlay"><i class="ot-flaticon-add"></i></span>
                                    </div>
                                </div>
                                <div class="info-box">
                                    <h4>SSCC Energy-Saving</h4>
                                    <p>Our specialists believe in building a greener and sustainable tomorrow. We offer our clients turnkey energy saving solutions enabling them to drastically reduce their operating expenses.</p>
                                    <a class="btn-details" href="#">Read More</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-12 col-md-12 align-self-center mb-5 mb-xl-0">
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                <div class="icon-box icon-box--bg-img icon-box--icon-top icon-box--is-line-hover s2 text-center">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                <div class="icon-box icon-box--bg-img icon-box--icon-top icon-box--is-line-hover s2 text-center mb-0">
                        ...
                        <div class="feature-content">
                            ...
                            <div class="ot-tabs tabs-light">
                                ...
                                <div id="tab-1" class="tab-content current">
                                    <ul>
                                        <li>1500+
                                            Buildings constructed across the region since 1993
                                        </li>
                                        <li>30,000+
                                            Tons structural steel erected per year</li>
                                        <li>3 million+
                                            m² high tolerance industrial slabs casted since 1993</li>
                                        <li>$500+ Million
                                            Project revenue executed by Aviation Fueling since 2006</li>
                                    </ul>
                                </div>
                                <div id="tab-2" class="tab-content">
                                    <ul>
                                        ...
                                        <li>International Industrial Construction Award, 2015</li>
                            ...
                            <div class="row mb-md-70">
                                <div class="col-md-6 col-sm-12">
                                    <div class="icon-box icon-box--classic icon-box--icon-top mb-4 mb-md-0">
                                        ...
                                        <div class="content-box">
                                            <h5><a href="#" class="title-link">  DEWA </a></h5>
                                            <p>Approved</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="icon-box icon-box--classic icon-box--icon-top mb-4 mb-md-0">
                                        ...
                                        <div class="content-box">
                                            <h5><a href="#" class="title-link">
                                            Carbon Reduction                                    </a></h5>
                                            <p>Cleaner energy solutions</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="icon-box icon-box--classic icon-box--icon-top mb-4 mb-md-0">
                                        ...
                                        <div class="content-box">
                                            <h5><a href="#" class="title-link">
                                            In-house Expertise                                    </a></h5>
                                            <p>Unmatched advantages for clients  </p>
                                        </div>
                                    </div>
                                </div>
