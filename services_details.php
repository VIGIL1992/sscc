                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="icon-box icon-box--classic icon-box--icon-top mb-0">
                                        ...
                                        <div class="content-box">
                                            ...
                                            <p>We develop an attractive and convenient space for work and leisure time, working on units, selecting materials, manufacturers. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="our-services">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="icon-box icon-box--bg-img icon-box--icon-top icon-box--is-line-hover icon-bg-2 text-center minheight560">
                            <div class="icon-main"><img src="images/iconbox2.png" alt=""></div>
                            <div class="content-box">
                                <h5><a href="services_details.php">Construction</a></h5>
                                <p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="icon-box icon-box--bg-img icon-box--icon-top icon-box--is-line-hover icon-bg-3 text-center minheight560">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 align-self-center">
                        <div class="process-classic sleft text-center text-lg-right px-5 px-lg-0">
                            <span>01.</span>
                            <h6>Apartment Design</h6>
                            <p class="px-md-5 px-lg-0">The design of apartments, individual houses is one of the most difficult tasks.</p>
                        </div>
                        <div class="process-classic sleft text-center text-lg-right px-5 px-lg-0 mb-lg-0">
                            <span>02.</span>
                            <h6>Shop Design</h6>
                            <p class="px-md-5 px-lg-0">For our customers we offer a complete «key ready» project implementation.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 align-self-center">
                        <div class="process-classic sright text-center text-lg-left px-5 px-lg-0">
                            <span>03.</span>
                            <h6>Office Design</h6>
                            <p class="px-md-5 px-lg-0">The design of apartments, individual houses is one of the most difficult tasks.</p>
                        </div>
                        <div class="process-classic sright text-center text-lg-left px-5 px-lg-0 mb-lg-0">
                            <span>01</span>
                            <h6>House Design</h6>
                            <p class="px-md-5 px-lg-0">For our customers we offer a complete «key ready» project implementation.</p>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center pt-5">
                        <div class="ot-button">
                            <a href="about.php" class="octf-btn octf-btn-light border-hover-light">view more</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mb-4 mb-lg-0">
                            <h2 class="text-light1 mb-0">Get In Touch</h2>
                        ...
                        <div class="col-lg-4 text-left text-lg-right align-self-center">
                            <div class="ot-button">
                                <a href="contact.php" class="octf-btn octf-btn-light1 border-hover-light">get in touch</a>
                            </div>
                        </div>
                    </div>
                </div>
