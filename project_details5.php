...
<body>
    ...
    <div id="page" class="site">
        ...
        <div id="content" class="site-content">
            <div class="page-header dtable text-center header-transparent pheader-project-detail5">
                <div class="dcell">
                    <div class="container">
                        <h1 class="page-title">Project5</h1>
                        <ul id="breadcrumbs" class="breadcrumbs none-style">
                            <li><a href="index.php">Home</a></li>
                            <li><a href="portfolio.php">Our Projects</a></li>
                            <li class="active">Project5</li>
                        </ul>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="project-item category-14 ">
                                                <div class="projects-box">
                                                    ...
                                                    <div class="portfolio-info">
                                                        ...
                                                        <a class="overlay" href="project_details17.php"></a>
                                                    </div>
                                                </div>
                                            </div>
