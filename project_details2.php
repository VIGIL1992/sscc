...
<body>
    ...
    <div id="page" class="site">
        ...
        <div id="content" class="site-content">
            <div class="page-header dtable text-center header-transparent pheader-project-detail2">
                <div class="dcell">
                    <div class="container">
                        <h1 class="page-title">Project2</h1>
                        <ul id="breadcrumbs" class="breadcrumbs none-style">
                            <li><a href="index.php">Home</a></li>
                            <li><a href="portfolio.php">Our Projects</a></li>
                            <li class="active">Project2</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="gallery-post img-slider owl-carousel owl-theme">
                                <div class="item-image">
                                    <img src="images/project/project7.jpg" alt="">
                                </div>
                                <div class="item-image">
                                    <img src="images/project/project7.jpg" alt="">
                                </div>
